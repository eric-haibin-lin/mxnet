...
class Comm {
 public:
   ...
   */
  virtual void InitEx(int key, const NDArrayStorageType stype,
...
class CommCPU : public Comm {
 public:
  ...
  void InitEx(int key, const NDArrayStorageType stype, const TShape& shape,
 ...
 private:
  ...
  // TODO(haibin) use kernel to parallelize the summation
