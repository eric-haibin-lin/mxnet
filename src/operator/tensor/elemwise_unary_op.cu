...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, kernel_launch_op::relu_grad>);

NNVM_REGISTER_OP(sigmoid)
.set_attr<FCompute>("FCompute<gpu>", UnaryOp::Launch<gpu, kernel_launch_op::sigmoid>)
.set_attr<FComputeEx>("FComputeEx<gpu>", UnaryOp::LaunchEx<gpu, kernel_launch_op::sigmoid>);

NNVM_REGISTER_OP(_backward_sigmoid)
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, kernel_launch_op::sigmoid_grad>);
...
.set_attr<FCompute>("FCompute<gpu>", UnaryOp::IdentityCompute<gpu>)
.set_attr<FComputeEx>(FCOMP_EX_CPU, UnaryOp::IdentityComputeFirstItemsEx<gpu>);
...
.set_attr<FCompute>("FCompute<gpu>", UnaryOp::IdentityCompute<cpu>)
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::sign> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::sign_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::square_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::square_root_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>",
  BinaryOp::Launch<gpu, unary_bwd<mshadow_op::reciprocal_square_root_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::log_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::log1p_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::exp> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::sin_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::cos_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::tan_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::arcsin_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::arccos_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::arctan_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::degrees_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::radians_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::cosh_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::sinh_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::tanh_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::arcsinh_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::arccosh_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::arctanh_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::gamma_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryOp::Launch<gpu, unary_bwd<mshadow_op::gammaln_grad> >);
