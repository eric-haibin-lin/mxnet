...
.set_attr<FInferShape>("FInferShape", InitShape<InitOpParam>)
.set_attr<FInferType>("FInferType", InitType<InitOpParam>)
...
.set_attr<FInferShape>("FInferShape", RangeShape)
.set_attr<FInferType>("FInferType", InitType<RangeParam>)
