...
def allreduce(tensor, average=True, name=None, priority=0, group_id=None):
    """
    ...
    Arguments:
        ...
        group_id: Optional integer id to explicitly group reduction operations.
    ...
    if isinstance(name, string_types):
        check_call(MPI_MXNET_LIB_CTYPES.horovod_mxnet_allreduce_async(
            ...
            ctypes.c_bool(group_id is not None), group_id if group_id is not None else -1))
    else:
        check_call(MPI_MXNET_LIB_CTYPES.horovod_mxnet_allreduce_async(
...
def allreduce_(tensor, average=True, name=None, priority=0, group_id=None):
    """
