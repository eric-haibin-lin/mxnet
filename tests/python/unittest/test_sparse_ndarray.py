...
def test_synthetic_dataset_generator():
    ...
    _test_powerlaw(csr_arr_cols, final_row=9)
    _test_powerlaw(csr_arr_small, final_row=1)
    _test_powerlaw(csr_arr_big, final_row=4)
    _test_powerlaw(csr_arr_square, final_row=6)
