...
def check_rnn_consistency(cell1, cell2, T, N, I, H, grad_req, rtol=1e-2, atol=1e-4):
    ...
    assert_allclose(mod1.get_outputs()[0], mod2.get_outputs()[0], rtol=rtol, atol=atol)
    ...
    if grad_req != 'null':
        assert_allclose(mod1.get_input_grads()[0], mod2.get_input_grads()[0], rtol=rtol, atol=atol)
    else:
